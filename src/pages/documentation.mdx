...
import { Count, RestQuery } from "../components/docs/mdx";
...
<RestQuery endpoint="/character/?page=19"/>
...
You can also quickly start using the API with this [Postman collection](https://github.com/loopDelicious/rick-and-morty-postman) created by [loopDelicious](https://github.com/loopDelicious).

If you are looking for a **JavaScript** library, you can check [The Rick and Morty API JavaScript client](/documentation/#javascript-client)

### Dart
[Rick and Morty API Dart Client](https://github.com/Yash-Garg/RickandMorty-Dart-Wrapper) by [Yash Garg](https://github.com/Yash-Garg)
...
### PHP
[Rick and Morty API PHP Client](https://github.com/nickbeen/rick-and-morty-api-php) by [Nick Been](https://github.com/nickbeen)
...
### Rust
[rick-and-morty crate](https://github.com/dshomoye/rick-and-morty) by [dshomoye](https://github.com/dshomoye)
