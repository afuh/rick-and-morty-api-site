...
You can get a single random character: `/character/random`

<RestQuery endpoint="/character/random"/>
...
You can get a single randomlocation: `/location/random`

<RestQuery endpoint="/location/random"/>
...
You can get a single random episode: `/episode/random`

<RestQuery endpoint="/episode/random"/>
